...
class BasePlotter(metaclass=abc.ABCMeta):
    """
    Abstract base plot class that supports up to three-dimensional figures.
    """
...
class BrightnessHistogram:
    ...
    def __init__(
        ...
        *,
        ...
        """
        Generates a brightness histogram from a list of brightness values (floats)
...
class ClusterPlot:
    ...
    def __init__(
        ...
        """
        This plot is used to help determine the amount of clusters to use for brightness
        thresholding.
